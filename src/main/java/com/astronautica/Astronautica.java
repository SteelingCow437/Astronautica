...
import com.astronautica.event.ModEvents;
import com.astronautica.item.ModCreativeModeTab;
import com.astronautica.item.ModItems;
import com.astronautica.potion.ModPotions;
...
@Mod(Astronautica.MOD_ID)
public class Astronautica {

    public static final String MOD_ID = "astronautica";
